    ...
    <div class="ill_page">
        ...
        <div class="item_list">
            <div class="item" v-for="(item, index) in ill_item" :key="index">
                ...
                <div class="work_info">
                    <div class="work_name">
                        <span @click="open_ill_content_page(item.work.Illustration_id)">{{ item.work.name }}</span>
                    </div>
                    <span>作品ID：{{ item.work.Illustration_id }}</span>
                    <div class="work_tags">
...
//打开内容页,并设置参数
function open_ill_content_page(work_id){
