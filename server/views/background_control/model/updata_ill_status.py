            ...
            if is_authenticated:
                ...
                with connection.cursor() as cursor:
                    ...
                    if account_permissions in [1, 2, '1', '2']:
                        ...
                        ill_id = data.get('work_id', None)

                        # 更新插画的审核状态
                        sql = '''UPDATE illustration_work SET work_approved=%s WHERE Illustration_id=%s'''
                        cursor.execute(sql, [work_status, ill_id])
